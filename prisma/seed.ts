...
async function main() {
  ...
  const groupMatches: GroupMatchRow[] = [
    ...
    [8,  "Grupo", "D", "2026-06-13T04:00:00.000Z", "Austrália", "Turquia", "BC Place"],
    ...
    [21, "Grupo", "K", "2026-06-18T02:00:00.000Z", "Colômbia", "Uzbequistão", "Estadio Azteca"],
    ...
    [31, "Grupo", "C", "2026-06-20T01:00:00.000Z", "Brasil", "Haiti", "Lincoln Financial Field"],
    [32, "Grupo", "D", "2026-06-19T04:00:00.000Z", "Paraguai", "Turquia", "Levi's Stadium"],
